...
static spinlock_t plxIoLock;

#define MODEL_PREFIX Semi_Bridgeless_PFC_990W_converter_RT_BOX
#define MODEL_NAME "Semi_Bridgeless_PFC_990W_converter_RT_BOX"
...
const char* plxGetModelName(void)
{

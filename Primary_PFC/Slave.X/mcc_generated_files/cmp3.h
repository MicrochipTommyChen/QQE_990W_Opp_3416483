...
typedef enum
{
	CMP3_INPUT_SPGA2_OUTPUT = 0x5, //SPGA2 Output
	CMP3_INPUT_SPGA1_OUTPUT = 0x4, //SPGA1 Output
	CMP3_INPUT_S1CMP3D = 0x3, //S1CMP3D
	CMP3_INPUT_SPGA3_OUTPUT = 0x2, //SPGA3 Output
	CMP3_INPUT_S1CMP3B = 0x1, //S1CMP3B
	CMP3_INPUT_S1CMP3A = 0x0, //S1CMP3A
}CMP3_INPUT;
...
typedef enum
{
	CMP3_START_MASTER_PWM2_TRIGGER1 = 0xe, 
	CMP3_START_MASTER_PWM1_TRIGGER1 = 0xd, 
	CMP3_START_SLAVE_PWM8_TRIGGER1 = 0x8, 
	CMP3_START_SLAVE_PWM7_TRIGGER1 = 0x7, 
	CMP3_START_SLAVE_PWM6_TRIGGER1 = 0x6, 
	CMP3_START_SLAVE_PWM5_TRIGGER1 = 0x5, 
	CMP3_START_SLAVE_PWM4_TRIGGER1 = 0x4, 
	CMP3_START_SLAVE_PWM3_TRIGGER1 = 0x3, 
	CMP3_START_SLAVE_PWM2_TRIGGER1 = 0x2, 
	CMP3_START_SLAVE_PWM1_TRIGGER1 = 0x1, 
	CMP3_START_NONE = 0x0, 
}CMP3_START_TRIGGER;
...
typedef enum
{
	CMP3_STOPA_MASTER_PWM2_TRIGGER2 = 0xe, 
	CMP3_STOPA_MASTER_PWM1_TRIGGER2 = 0xd, 
	CMP3_STOPA_SLAVE_PWM8_TRIGGER2 = 0x8, 
	CMP3_STOPA_SLAVE_PWM7_TRIGGER2 = 0x7, 
	CMP3_STOPA_SLAVE_PWM6_TRIGGER2 = 0x6, 
	CMP3_STOPA_SLAVE_PWM5_TRIGGER2 = 0x5, 
	CMP3_STOPA_SLAVE_PWM4_TRIGGER2 = 0x4, 
	CMP3_STOPA_SLAVE_PWM3_TRIGGER2 = 0x3, 
	CMP3_STOPA_SLAVE_PWM2_TRIGGER2 = 0x2, 
	CMP3_STOPA_SLAVE_PWM1_TRIGGER2 = 0x1, 
	CMP3_STOPA_NONE = 0x0, 
}CMP3_STOPA_TRIGGER;
...
typedef enum
{
	CMP3_STOPB_CMP1_OUTPUT = 0x4, 
	CMP3_STOPB_S1CMP3_OUTPUT = 0x3, 
	CMP3_STOPB_S1CMP2_OUTPUT = 0x2, 
	CMP3_STOPB_S1CMP1_OUTPUT = 0x1, 
	CMP3_STOPB_NONE = 0x0, 
}CMP3_STOPB_TRIGGER;
...
typedef enum
{
	CMP3_HYSTERETIC_FUNCTION_PWM4H = 0xc, 
	CMP3_HYSTERETIC_FUNCTION_PWM3H = 0xb, 
	CMP3_HYSTERETIC_FUNCTION_PWM2H = 0xa, 
	CMP3_HYSTERETIC_FUNCTION_PWM1H = 0x9, 
	CMP3_HYSTERETIC_FUNCTION_S1PWM8H = 0x8, 
	CMP3_HYSTERETIC_FUNCTION_S1PWM7H = 0x7, 
	CMP3_HYSTERETIC_FUNCTION_S1PWM6H = 0x6, 
	CMP3_HYSTERETIC_FUNCTION_S1PWM5H = 0x5, 
	CMP3_HYSTERETIC_FUNCTION_S1PWM4H = 0x4, 
	CMP3_HYSTERETIC_FUNCTION_S1PWM3H = 0x3, 
	CMP3_HYSTERETIC_FUNCTION_S1PWM2H = 0x2, 
	CMP3_HYSTERETIC_FUNCTION_S1PWM1H = 0x1, 
